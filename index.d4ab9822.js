let t;function e(t){return t&&t.__esModule?t.default:t}var r,n,o,i,s,a="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},l={},u={},f=a.parcelRequire0a78;function c(t,e){return function(){return t.apply(e,arguments)}}null==f&&((f=function(t){if(t in l)return l[t].exports;if(t in u){var e=u[t];delete u[t];var r={id:t,exports:{}};return l[t]=r,e.call(r.exports,r,r.exports),r.exports}var n=Error("Cannot find module '"+t+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(t,e){u[t]=e},a.parcelRequire0a78=f),f("8FnLx"),f("4S0r6");// utils is a library of generic helper functions non-specific to axios
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&E(t.buffer)},isString:w,isNumber:O,isBoolean:t=>!0===t||!1===t,isObject:A,isPlainObject:S,isUndefined:b,isDate:R,isFile:B,isBlob:T,isRegExp:k,isFunction:v,isStream:t=>A(t)&&v(t.pipe),isURLSearchParams:L,isTypedArray:_,isFileList:U,forEach:I,merge:/**
...
function tx(t){return"undefined"==typeof BigInt?t_:t}function t_(){throw Error("BigInt not supported")}/**
...
r=tP(r),a.forEach(function(t,n){z.isUndefined(t)||null===t||e.append(!0===s?tk([r],n,i):null===s?r:r+"[]",u(t))}),!1)}}return!!tj(t)||(e.append(tk(o,r,i),u(t)),!1)}let c=[],h=Object.assign(tF,{defaultVisitor:f,convertValue:u,isVisitable:tj});if(!z.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!z.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),z.forEach(r,function(r,i){let s=!(z.isUndefined(r)||null===r)&&o.call(e,r,z.isString(i)?i.trim():i,n,h);!0===s&&t(r,n?n.concat(i):[i])}),c.pop()}}(t),e};/**
 ...
 */t2=t=>{let e,r,n;let o={};return t&&t.split("\n").forEach(function(t){n=t.indexOf(":"),e=t.substring(0,n).trim().toLowerCase(),r=t.substring(n+1).trim(),!e||o[e]&&t1[e]||("set-cookie"===e?o[e]?o[e].push(r):o[e]=[r]:o[e]=o[e]?o[e]+", "+r:r)}),o};const t6=Symbol("internals");function t8(t){return t&&String(t).trim().toLowerCase()}function t5(t){return!1===t||null==t?t:z.isArray(t)?t.map(t5):String(t)}const t4=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function t3(t,e,r,n,o){if(z.isFunction(n))return n.call(this,e,r);if(o&&(e=r),z.isString(e)){if(z.isString(n))return -1!==e.indexOf(n);if(z.isRegExp(n))return n.test(e)}}class t7{constructor(t){t&&this.set(t)}set(t,e,r){let n=this;function o(t,e,r){let o=t8(e);if(!o)throw Error("header name must be a non-empty string");let i=z.findKey(n,o);i&&void 0!==n[i]&&!0!==r&&(void 0!==r||!1===n[i])||(n[i||e]=t5(t))}let i=(t,e)=>z.forEach(t,(t,r)=>o(t,r,e));return z.isPlainObject(t)||t instanceof this.constructor?i(t,e):z.isString(t)&&(t=t.trim())&&!t4(t)?i(t2(t),e):null!=t&&o(e,t,r),this}get(t,e){if(t=t8(t)){let r=z.findKey(this,t);if(r){let t=this[r];if(!e)return t;if(!0===e)return function(t){let e;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)r[e[1]]=e[2];return r}(t);if(z.isFunction(e))return e.call(this,t,r);if(z.isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=t8(t)){let r=z.findKey(this,t);return!!(r&&void 0!==this[r]&&(!e||t3(this,this[r],r,e)))}return!1}delete(t,e){let r=this,n=!1;function o(t){if(t=t8(t)){let o=z.findKey(r,t);o&&(!e||t3(r,r[o],o,e))&&(delete r[o],n=!0)}}return z.isArray(t)?t.forEach(o):o(t),n}clear(t){let e=Object.keys(this),r=e.length,n=!1;for(;r--;){let o=e[r];(!t||t3(this,this[o],o,t,!0))&&(delete this[o],n=!0)}return n}normalize(t){let e=this,r={};return z.forEach(this,(n,o)=>{let i=z.findKey(r,o);if(i){e[i]=t5(n),delete e[o];return}let s=t?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,r)=>e.toUpperCase()+r):String(o).trim();s!==o&&delete e[o],e[s]=t5(n),r[s]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return z.forEach(this,(r,n)=>{null!=r&&!1!==r&&(e[n]=t&&z.isArray(r)?r.join(", "):r)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let r=new this(t);return e.forEach(t=>r.set(t)),r}static accessor(t){let e=this[t6]=this[t6]={accessors:{}},r=e.accessors,n=this.prototype;function o(t){let e=t8(t);r[e]||(!function(t,e){let r=z.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+r,{value:function(t,r,o){return this[n].call(this,e,t,r,o)},configurable:!0})})}(n,t),r[e]=!0)}return z.isArray(t)?t.forEach(o):o(t),this}}function t9(t,e){let r=this||t0,n=e||r,o=t7.from(n.headers),i=n.data;return z.forEach(t,function(t){i=t.call(r,i,o.normalize(),e?e.status:void 0)}),o.normalize(),i}function et(t){return!!(t&&t.__CANCEL__)}/**
...
const{Axios:eS,AxiosError:eR,CanceledError:eB,isCancel:eT,CancelToken:eU,VERSION:eL,all:eI,Cancel:eN,isAxiosError:eC,spread:ex,toFormData:e_,AxiosHeaders:ej,HttpStatusCode:eP,formToJSON:ek,getAdapter:eF,mergeConfig:eD}=eA,e$="https://books-backend.p.goit.global/books";class eM{async fetchCategoryList(){let t=await eA.get(`${e$}/category-list`);return t.data}async fetchTopBooks(){let t=await eA.get(`${e$}/top-books`);return t.data}async fetchBooksByCategory(t){let e=await eA.get(`${e$}/category?category=${t}`);return e.data}async fetchDetailsByBookId(t){let e=await eA.get(`${e$}/${t}`);return e.data}}var eq=f("9B8F0"),ez=f("7Y9D8"),eH=f("4QZR6"),eJ={};eJ=new URL(f("kyEFX").resolve("jMWDt"),import.meta.url).toString();var eV={};eV=new URL(f("kyEFX").resolve("7FDwr"),import.meta.url).toString();var eG={};eG=new URL(f("kyEFX").resolve("aXtmN"),import.meta.url).toString();var eW={};eW=new URL(f("kyEFX").resolve("aqdGz"),import.meta.url).toString();const eK=new eM,eY=eq.create('<div class="js-modal"></div>',{onShow:()=>{document.addEventListener("keydown",eZ),document.body.style.overflow="hidden"},onClose:()=>{document.removeEventListener("keydown",eZ),document.body.style.overflow="visible"}});async function eX(t){try{e1=await eK.fetchDetailsByBookId(t);let{book_image:r,title:n,author:o,description:i,buy_links:s}=e1;eY.show();let a=document.querySelector(".js-modal");a.innerHTML=`<div class="modal container">
...
let e0=[],e1={};function e2(t){var e;let r=t.target.dataset.id,n=document.querySelector(".text-info");e0.find(t=>t._id===r)?(e0=e0.filter(t=>t._id!==r),t.target.textContent="ADD TO SHOPING LIST",n.classList.add("is-hidden")):(e0.push(e1),t.target.textContent="REMOVE FROM THE SHOPPING LIST",n.classList.remove("is-hidden")),e=e0,(0,eH.user).writeBooksToDB(eH.user.userID,JSON.stringify(e))}(0,eH.user).readUserData(eH.user.userID).then(t=>{t&&t.books&&(e0=JSON.parse(t.books))});var ez=f("7Y9D8");const e6=document.querySelector(".js-cards"),e8=new eM;async function e5(){/*@__PURE__*/e(ez).Loading.standard();try{let t=await e8.fetchTopBooks(),e=t.map(t=>`<div>
      ...
      </div>`}e5();var ez=f("7Y9D8");document.querySelector(".js-cards");const e7=document.querySelector(".categoryes");(async function(){try{let t=new eM,r=await t.fetchCategoryList(),n=r.map(t=>`<li class="categorie-item"><button data-list_name="${t.list_name}" class="categorie-btn">${t.list_name}</button>
      </li>`).join("");e7.innerHTML=`<ul class="categorie-list list"><li class="categorie-item"><button class="categorie-btn active">All categories</button></li>${n}</ul>`,0===r.length&&/*@__PURE__*/e(ez).Notify.failure("No categories found");let o=document.querySelectorAll(".categorie-btn");o.forEach(t=>{t.addEventListener("click",e=>{document.querySelector(".categorie-btn.active").classList.remove("active"),e4(t.textContent),t.classList.add("active")})})}catch(t){/*@__PURE__*/e(ez).Notify.failure(t.message)}})(),f("fKLyw"),f("74Aiq"),f("epHO8"),f("cIjUs"),f("4QZR6"),f("6zeq2");const e9=document.querySelectorAll(".js-index_menu");e9.forEach(t=>t.classList.add("active"));//# sourceMappingURL=index.d4ab9822.js.map

//# sourceMappingURL=index.d4ab9822.js.map
