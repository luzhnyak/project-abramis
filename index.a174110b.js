!function(){let t;function e(t){return t&&t.__esModule?t.default:t}var r,n,o,i,s,a="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},l={},u={},f=a.parcelRequire0a78;function c(t,e){return function(){return t.apply(e,arguments)}}null==f&&((f=function(t){if(t in l)return l[t].exports;if(t in u){var e=u[t];delete u[t];var r={id:t,exports:{}};return l[t]=r,e.call(r.exports,r,r.exports),r.exports}var n=Error("Cannot find module '"+t+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(t,e){u[t]=e},a.parcelRequire0a78=f),f.register("aNJCr",function(t,e){Object.defineProperty(t.exports,"getBundleURL",{get:function(){return r},set:function(t){return r=t},enumerable:!0,configurable:!0});var r,n={};r=function(t){var e=n[t];return e||(e=function(){try{throw Error()}catch(e){var t=(""+e.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(t)// Use the 3rd one, which will be a runtime in the original bundle.
return(""+t[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),n[t]=e),e}}),f("cs7FV"),f("9VC5X");// utils is a library of generic helper functions non-specific to axios
let{toString:h}=Object.prototype,{getPrototypeOf:p}=Object,d=(r=Object.create(null),t=>{let e=h.call(t);return r[e]||(r[e]=e.slice(8,-1).toLowerCase())}),g=t=>(t=t.toLowerCase(),e=>d(e)===t),y=t=>e=>typeof e===t,{isArray:m}=Array,b=y("undefined"),E=g("ArrayBuffer"),w=y("string"),v=y("function"),O=y("number"),A=t=>null!==t&&"object"==typeof t,B=t=>{if("object"!==d(t))return!1;let e=p(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},S=g("Date"),R=g("File"),T=g("Blob"),U=g("FileList"),L=g("URLSearchParams");/**
 ...
 * @returns {any}
 */function N(t,e,{allOwnKeys:r=!1}={}){let n,o;// Don't bother if no value provided
...
let i=r?Object.getOwnPropertyNames(t):Object.keys(t),s=i.length;for(n=0;n<s;n++)o=i[n],e.call(null,t[o],o,t)}}}function C(t,e){let r;e=e.toLowerCase();let n=Object.keys(t),o=n.length;for(;o-- >0;)if(e===(r=n[o]).toLowerCase())return r;return null}let I=/*eslint no-undef:0*/"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:a,x=t=>!b(t)&&t!==I,j=(n="undefined"!=typeof Uint8Array&&p(Uint8Array),t=>n&&t instanceof n),_=g("HTMLFormElement"),P=(({hasOwnProperty:t})=>(e,r)=>t.call(e,r))(Object.prototype),k=g("RegExp"),D=(t,e)=>{let r=Object.getOwnPropertyDescriptors(t),n={};N(r,(r,o)=>{let i;!1!==(i=e(r,o,t))&&(n[o]=i||r)}),Object.defineProperties(t,n)},F="abcdefghijklmnopqrstuvwxyz",$="0123456789",M={DIGIT:$,ALPHA:F,ALPHA_DIGIT:F+F.toUpperCase()+$},q=g("AsyncFunction");var z={isArray:m,isArrayBuffer:E,isBuffer:/**
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&E(t.buffer)},isString:w,isNumber:O,isBoolean:t=>!0===t||!1===t,isObject:A,isPlainObject:B,isUndefined:b,isDate:S,isFile:R,isBlob:T,isRegExp:k,isFunction:v,isStream:t=>A(t)&&v(t.pipe),isURLSearchParams:L,isTypedArray:j,isFileList:U,forEach:N,merge:/**
 ...
 */function t(){let{caseless:e}=x(this)&&this||{},r={},n=(n,o)=>{let i=e&&C(r,o)||o;B(r[i])&&B(n)?r[i]=t(r[i],n):B(n)?r[i]=t({},n):m(n)?r[i]=n.slice():r[i]=n};for(let t=0,e=arguments.length;t<e;t++)arguments[t]&&N(arguments[t],n);return r},extend:(t,e,r,{allOwnKeys:n}={})=>(N(e,(e,n)=>{r&&v(e)?t[n]=c(e,r):t[n]=e},{allOwnKeys:n}),t),trim:t=>t.trim?t.trim():t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""),stripBOM:t=>(65279===t.charCodeAt(0)&&(t=t.slice(1)),t),inherits:(t,e,r,n)=>{t.prototype=Object.create(e.prototype,n),t.prototype.constructor=t,Object.defineProperty(t,"super",{value:e.prototype}),r&&Object.assign(t.prototype,r)},toFlatObject:(t,e,r,n)=>{let o,i,s;let a={};// eslint-disable-next-line no-eq-null,eqeqeq
...
)o.push(function(t,e,r){for(var n,o=[],i=e;i<r;i+=3)o.push(G[(n=(t[i]<<16&16711680)+(t[i+1]<<8&65280)+(255&t[i+2]))>>18&63]+G[n>>12&63]+G[n>>6&63]+G[63&n]);return o.join("")}(t,i,i+16383>s?s:i+16383));return 1===n?o.push(G[(e=t[r-1])>>2]+G[e<<4&63]+"=="):2===n&&o.push(G[(e=(t[r-2]<<8)+t[r-1])>>10]+G[e>>4&63]+G[e<<2&63]+"="),o.join("")};for(var G=[],W=[],K="undefined"!=typeof Uint8Array?Uint8Array:Array,Y="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",X=0,Q=Y.length;X<Q;++X)G[X]=Y[X],W[Y.charCodeAt(X)]=X;// Support decoding URL-safe base64 strings, as Node.js does.
// See: https://en.wikipedia.org/wiki/Base64#URL_applications
W["-".charCodeAt(0)]=62,W["_".charCodeAt(0)]=63,i=function(t,e,r,n,o){var i,s,a=8*o-n-1,l=(1<<a)-1,u=l>>1,f=-7,c=r?o-1:0,h=r?-1:1,p=t[e+c];for(c+=h,i=p&(1<<-f)-1,p>>=-f,f+=a;f>0;i=256*i+t[e+c],c+=h,f-=8);for(s=i&(1<<-f)-1,i>>=-f,f+=n;f>0;s=256*s+t[e+c],c+=h,f-=8);if(0===i)i=1-u;else{if(i===l)return s?NaN:(p?-1:1)*(1/0);s+=Math.pow(2,n),i-=u}return(p?-1:1)*s*Math.pow(2,i-n)},s=function(t,e,r,n,o,i){var s,a,l,u=8*i-o-1,f=(1<<u)-1,c=f>>1,h=23===o?5960464477539062e-23:0,p=n?0:i-1,d=n?1:-1,g=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,s=f):(s=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-s))<1&&(s--,l*=2),s+c>=1?e+=h/l:e+=h*Math.pow(2,1-c),e*l>=2&&(s++,l/=2),s+c>=f?(a=0,s=f):s+c>=1?(a=(e*l-1)*Math.pow(2,o),s+=c):(a=e*Math.pow(2,c-1)*Math.pow(2,o),s=0));o>=8;t[r+p]=255&a,p+=d,a/=256,o-=8);for(s=s<<o|a,u+=o;u>0;t[r+p]=255&s,p+=d,s/=256,u-=8);t[r+p-d]|=128*g};let Z="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
;e=(""+e).toLowerCase(),o=!0}}function tu(t,e,r){let n=!1;// Return early if start > this.length. Done here to prevent potential uint32
// coercion fail below.
...
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function tA(t){let e="",r=t.length,n="-"===t[0]?1:0;for(;r>=n+4;r-=3)e=`_${t.slice(r-3,r)}${e}`;return`${t.slice(0,r)}${e}`}function tB(t,e,r,n,o,i){if(t>r||t<e){let n;let o="bigint"==typeof e?"n":"";throw n=i>3?0===e||e===BigInt(0)?`>= 0${o} and < 2${o} ** ${(i+1)*8}${o}`:`>= -(2${o} ** ${(i+1)*8-1}${o}) and < 2 ** ${(i+1)*8-1}${o}`:`>= ${e}${o} and <= ${r}${o}`,new tv.ERR_OUT_OF_RANGE("value",n,t)}tS(o,"offset"),(void 0===n[o]||void 0===n[o+i])&&tR(o,n.length-(i+1))}function tS(t,e){if("number"!=typeof t)throw new tv.ERR_INVALID_ARG_TYPE(e,"number",t)}function tR(t,e,r){if(Math.floor(t)!==t)throw tS(t,r),new tv.ERR_OUT_OF_RANGE(r||"offset","an integer",t);if(e<0)throw new tv.ERR_BUFFER_OUT_OF_BOUNDS;throw new tv.ERR_OUT_OF_RANGE(r||"offset",`>= ${r?1:0} and <= ${e}`,t)}tO("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),tO("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),tO("ERR_OUT_OF_RANGE",function(t,e,r){let n=`The value of "${t}" is out of range.`,o=r;return Number.isInteger(r)&&Math.abs(r)>4294967296?o=tA(String(r)):"bigint"==typeof r&&(o=String(r),(r>BigInt(2)**BigInt(32)||r<-(BigInt(2)**BigInt(32)))&&(o=tA(o)),o+="n"),n+=` It must be ${e}. Received ${o}`},RangeError);// HELPER FUNCTIONS
// ================
let tT=/[^+/0-9A-Za-z-_]/g;function tU(t,e){let r;e=e||1/0;let n=t.length,o=null,i=[];for(let s=0;s<n;++s){// is surrogate component
...
for(;t.length%4!=0;)t+="=";return t}(t))}function tN(t,e,r,n){let o;for(o=0;o<n&&!(o+r>=e.length)&&!(o>=t.length);++o)e[o+r]=t[o];return o}// ArrayBuffer or Uint8Array objects from other contexts (i.e. iframes) do not pass
...
let tI=function(){let t="0123456789abcdef",e=Array(256);for(let r=0;r<16;++r){let n=16*r;for(let o=0;o<16;++o)e[n+o]=t[r]+t[o]}return e}();// Return not function with Error if BigInt not supported
...
t=tP(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}let tD=z.toFlatObject(z,{},null,function(t){return/^is[A-Z]/.test(t)});var tF=/**
...
r=tP(r),a.forEach(function(t,n){z.isUndefined(t)||null===t||e.append(!0===s?tk([r],n,i):null===s?r:r+"[]",u(t))}),!1)}}return!!t_(t)||(e.append(tk(o,r,i),u(t)),!1)}let c=[],h=Object.assign(tD,{defaultVisitor:f,convertValue:u,isVisitable:t_});if(!z.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!z.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),z.forEach(r,function(r,i){let s=!(z.isUndefined(r)||null===r)&&o.call(e,r,z.isString(i)?i.trim():i,n,h);!0===s&&t(r,n?n.concat(i):[i])}),c.pop()}}(t),e};/**
 ...
 *
 * @returns {void}
 */function tM(t,e){this._pairs=[],t&&tF(t,this,e)}let tq=tM.prototype;/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var tQ={classes:{URLSearchParams:tG,FormData:tW,Blob:tK},isStandardBrowserEnv:tY,isStandardBrowserWebWorkerEnv:tX,protocols:["http","https","file","blob","url","data"]},tZ=/**
 ...
 * @returns {Function}
 */function(t,e){let r;t=t||10;let n=Array(t),o=Array(t),i=0,s=0;return e=void 0!==e?e:1e3,function(a){let l=Date.now(),u=o[s];r||(r=l),n[i]=a,o[i]=l;let f=s,c=0;for(;f!==i;)c+=n[f++],f%=t;if((i=(i+1)%t)===s&&(s=(s+1)%t),l-r<e)return;let h=u&&l-u;return h?Math.round(1e3*c/h):void 0}};function es(t,e){let r=0,n=ei(50,250);return o=>{let i=o.loaded,s=o.lengthComputable?o.total:void 0,a=i-r,l=n(a),u=i<=s;r=i;let f={loaded:i,total:s,progress:s?i/s:void 0,bytes:a,rate:l||void 0,estimated:l&&s&&u?(s-i)/l:void 0,event:o};f[e?"download":"upload"]=!0,t(f)}}let ea="undefined"!=typeof XMLHttpRequest;var el=ea&&function(t){return new Promise(function(e,r){let n,o=t.data,i=t7.from(t.headers).normalize(),s=t.responseType;function a(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}z.isFormData(o)&&(tQ.isStandardBrowserEnv||tQ.isStandardBrowserWebWorkerEnv?i.setContentType(!1):i.setContentType("multipart/form-data;",!1));let l=new XMLHttpRequest;// HTTP basic authentication
...
l.send(o||null)})};let eu={http:null,xhr:el};z.forEach(eu,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
...
e.data=t9.call(t,t.transformResponse,e),e.headers=t7.from(e.headers),e},function(e){return!et(e)&&(ec(t),e&&e.response&&(e.response.data=t9.call(t,t.transformResponse,e.response),e.response.headers=t7.from(e.response.headers))),Promise.reject(e)})}let ep=t=>t instanceof t7?t.toJSON():t;function ed(t,e){// eslint-disable-next-line no-param-reassign
 ...
 *
 * @returns {object}
 */function(t,e,r){if("object"!=typeof t)throw new H("options must be an object",H.ERR_BAD_OPTION_VALUE);let n=Object.keys(t),o=n.length;for(;o-- >0;){let i=n[o],s=e[i];if(s){let e=t[i],r=void 0===e||s(e,i,t);if(!0!==r)throw new H("option "+i+" must be "+r,H.ERR_BAD_OPTION_VALUE);continue}if(!0!==r)throw new H("Unknown option "+i,H.ERR_BAD_OPTION)}},validators:ey};let eE=eb.validators;/**
...
eA.CanceledError=ee,eA.CancelToken=ev,eA.isCancel=et,eA.VERSION=eg,eA.toFormData=tF,// Expose AxiosError class
...
let{Axios:eB,AxiosError:eS,CanceledError:eR,isCancel:eT,CancelToken:eU,VERSION:eL,all:eN,Cancel:eC,isAxiosError:eI,spread:ex,toFormData:ej,AxiosHeaders:e_,HttpStatusCode:eP,formToJSON:ek,getAdapter:eD,mergeConfig:eF}=eA,e$="https://books-backend.p.goit.global/books";class eM{async fetchCategoryList(){let t=await eA.get(`${e$}/category-list`);return t.data}async fetchTopBooks(){let t=await eA.get(`${e$}/top-books`);return t.data}async fetchBooksByCategory(t){let e=await eA.get(`${e$}/category?category=${t}`);return e.data}async fetchDetailsByBookId(t){let e=await eA.get(`${e$}/${t}`);return e.data}}var eq=f("dyT35"),ez=f("6JpON"),eH=f("d0uJe"),eJ={};eJ=f("aNJCr").getBundleURL("EVgbq")+f("iE7OH").resolve("9Ox11");var eV={};eV=f("aNJCr").getBundleURL("EVgbq")+f("iE7OH").resolve("2344Y");var eG={};eG=f("aNJCr").getBundleURL("EVgbq")+f("iE7OH").resolve("53vZ8");var eW={};eW=f("aNJCr").getBundleURL("EVgbq")+f("iE7OH").resolve("3muyk");let eK=new eM,eY=eq.create('<div class="js-modal"></div>',{onShow:()=>{document.addEventListener("keydown",eZ),document.body.style.overflow="hidden"},onClose:()=>{document.removeEventListener("keydown",eZ),document.body.style.overflow="visible"}});async function eX(t){try{e1=await eK.fetchDetailsByBookId(t);let{book_image:r,title:n,author:o,description:i,buy_links:s}=e1;eY.show();let a=document.querySelector(".js-modal");a.innerHTML=`<div class="modal container">
    <button class="modal-close-btn" type="button" aria-label="close">
      <img class="modal-close-svg" src="${/*@__PURE__*/e(eJ)}" alt="" width="24" height="24" loading="lazy"/>
    </button>
    <div class="modal-info">
    <img class="book-image" src="${r}" alt="" loading="lazy"/>
    <div class="book-info">
    <h2 class="title">${n}</h2>
    ...
    <ul class="buy-list list">
      <li class="buy-item">
        <a href="${s[0].url}"><img class="store-1" src="${/*@__PURE__*/e(eV)}" alt="" width="62" height="" loading="lazy"/></a>
      </li>
      <li class="buy-item">
        <a href="${s[1].url}"><img class="store-2" src="${/*@__PURE__*/e(eG)}" alt="" width="33" height="" loading="lazy"/></a>
      </li>
      <li class="buy-item">
        <a href="${s[2].url}"><img class="store-3" src="${/*@__PURE__*/e(eW)}" alt="" width="38" height="" loading="lazy"/></a>
      </li>
    </ul>
    </div>
    </div>
  ...
  `;let l=document.querySelector(".modal-close-btn");l.addEventListener("click",eQ);let u=document.querySelector(".js-add-list-btn");if(u.addEventListener("click",e2),!eH.user.isAuth){u.textContent="PLEASE SIGN IN TO CONTINUE",u.disabled=!0;return}e0.find(e=>e._id===t)?u.textContent="REMOVE FROM THE SHOPPING LIST":u.textContent="ADD TO SHOPING LIST"}catch(t){/*@__PURE__*/e(ez).Notify.failure(t.message)}}function eQ(t){eY.close()}function eZ(t){"Escape"===t.code&&eY.close()}// ================ Local Storage
let e0=[],e1={};function e2(t){var e;let r=t.target.dataset.id,n=document.querySelector(".text-info");e0.find(t=>t._id===r)?(e0=e0.filter(t=>t._id!==r),t.target.textContent="ADD TO SHOPING LIST",n.classList.add("is-hidden")):(e0.push(e1),t.target.textContent="REMOVE FROM THE SHOPPING LIST",n.classList.remove("is-hidden")),e=e0,(0,eH.user).writeBooksToDB(eH.user.userID,JSON.stringify(e))}(0,eH.user).readUserData(eH.user.userID).then(t=>{t&&t.books&&(e0=JSON.parse(t.books))});var ez=f("6JpON");let e6=document.querySelector(".js-cards"),e5=new eM;async function e8(){/*@__PURE__*/e(ez).Loading.standard();try{let t=await e5.fetchTopBooks(),e=t.map(t=>`<div>
        ...
        <div class='see-more-btn-container'><button class='see-more-btn' type="button" data-catname="${t.list_name}">See more</button></div>
         ...
         ${e}`;let r=document.querySelectorAll(".js-card-click"),n=document.querySelectorAll(".see-more-btn");r.forEach(t=>{t.addEventListener("click",t=>{eX(t.currentTarget.dataset.id)})}),n.forEach(t=>{t.addEventListener("click",t=>{e4(t.target.dataset.catname);let e=document.querySelector(".categorie-btn.active");e.classList.remove("active");let r=document.querySelectorAll(".categorie-btn");r.forEach(e=>{e.dataset.list_name===t.target.dataset.catname&&e.classList.add("active")})})})}catch(t){/*@__PURE__*/e(ez).Notify.failure(t.message)}/*@__PURE__*/e(ez).Loading.remove()}async function e4(t){/*@__PURE__*/e(ez).Loading.standard();try{let r=await e5.fetchBooksByCategory(t);if("All categories"===t){e8();return}0===r.length&&/*@__PURE__*/e(ez).Notify.failure("No books found in this category");let n=r.map(t=>e3(t,0)).join(""),o=t.trim().split(" ");e6.innerHTML=`<div>
        <h1 class="general-title">${o.slice(0,o.length-1).join(" ")}<span class="violet"> ${o[o.length-1]}</span>
        </h1>        
        <div class='category-books-container'>${n}</div>
      </div>`;let i=document.querySelectorAll(".js-card-click");i.forEach(t=>{t.addEventListener("click",t=>{eX(t.currentTarget.dataset.id)})})}catch(t){/*@__PURE__*/e(ez).Notify.failure(t.message)}window.scrollTo({top:0,left:0,behavior:"smooth"}),/*@__PURE__*/e(ez).Loading.remove()}function e3(t,e){return`<div class='one-book-container col-${e} js-card-click' data-id="${t._id}">
       <div class="wrap">
      ...
      </div>`}e8();var ez=f("6JpON");document.querySelector(".js-cards");let e7=document.querySelector(".categoryes");(async function(){try{let t=new eM,r=await t.fetchCategoryList(),n=r.map(t=>`<li class="categorie-item"><button data-list_name="${t.list_name}" class="categorie-btn">${t.list_name}</button>
      </li>`).join("");e7.innerHTML=`<ul class="categorie-list list"><li class="categorie-item"><button class="categorie-btn active">All categories</button></li>${n}</ul>`,0===r.length&&/*@__PURE__*/e(ez).Notify.failure("No categories found");let o=document.querySelectorAll(".categorie-btn");o.forEach(t=>{t.addEventListener("click",e=>{document.querySelector(".categorie-btn.active").classList.remove("active"),e4(t.textContent),t.classList.add("active")})})}catch(t){/*@__PURE__*/e(ez).Notify.failure(t.message)}})(),f("d6S5l"),f("23Ajj"),f("7hKzD"),f("yTOug"),f("d0uJe"),f("7ADRq");let e9=document.querySelectorAll(".js-index_menu");e9.forEach(t=>t.classList.add("active"))}();//# sourceMappingURL=index.a174110b.js.map

//# sourceMappingURL=index.a174110b.js.map
