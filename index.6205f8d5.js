!function(){let t;var e,r,n,o,i,s="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};function a(t){return t&&t.__esModule?t.default:t}var l={},u={},f=s.parcelRequire0a78;function c(t,e){return function(){return t.apply(e,arguments)}}null==f&&((f=function(t){if(t in l)return l[t].exports;if(t in u){var e=u[t];delete u[t];var r={id:t,exports:{}};return l[t]=r,e.call(r.exports,r,r.exports),r.exports}var n=Error("Cannot find module '"+t+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(t,e){u[t]=e},s.parcelRequire0a78=f),f.register("aNJCr",function(t,e){Object.defineProperty(t.exports,"getBundleURL",{get:function(){return r},set:function(t){return r=t},enumerable:!0,configurable:!0});var r,n={};r=function(t){var e=n[t];return e||(e=function(){try{throw Error()}catch(e){var t=(""+e.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(t)// Use the 3rd one, which will be a runtime in the original bundle.
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&E(t.buffer)},isString:w,isNumber:O,isBoolean:t=>!0===t||!1===t,isObject:A,isPlainObject:B,isUndefined:b,isDate:R,isFile:S,isBlob:T,isRegExp:k,isFunction:v,isStream:t=>A(t)&&v(t.pipe),isURLSearchParams:L,isTypedArray:j,isFileList:U,forEach:C,merge:/**
...
if(t>=2147483647)throw RangeError("Attempt to allocate Buffer larger than maximum size: 0x7fffffff bytes");return 0|t}function tl(t,e){if(te.isBuffer(t))return t.length;if(ArrayBuffer.isView(t)||tN(t,ArrayBuffer))return t.byteLength;if("string"!=typeof t)throw TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof t);let r=t.length,n=arguments.length>2&&!0===arguments[2];if(!n&&0===r)return 0;// Use a for loop to avoid recursion
...
for(;t.length%4!=0;)t+="=";return t}(t))}function tC(t,e,r,n){let o;for(o=0;o<n&&!(o+r>=e.length)&&!(o>=t.length);++o)e[o+r]=t[o];return o}// ArrayBuffer or Uint8Array objects from other contexts (i.e. iframes) do not pass
...
let{Axios:eB,AxiosError:eR,CanceledError:eS,isCancel:eT,CancelToken:eU,VERSION:eL,all:eC,Cancel:eN,isAxiosError:eI,spread:ex,toFormData:ej,AxiosHeaders:e_,HttpStatusCode:eP,formToJSON:ek,getAdapter:eD,mergeConfig:eF}=eA,e$="https://books-backend.p.goit.global/books";class eM{async fetchCategoryList(){let t=await eA.get(`${e$}/category-list`);return t.data}async fetchTopBooks(){let t=await eA.get(`${e$}/top-books`);return t.data}async fetchBooksByCategory(t){let e=await eA.get(`${e$}/category?category=${t}`);return e.data}async fetchDetailsByBookId(t){let e=await eA.get(`${e$}/${t}`);return e.data}}var eq=f("dyT35"),ez=f("d0uJe"),eH={};eH=f("aNJCr").getBundleURL("EVgbq")+f("iE7OH").resolve("9Ox11");var eJ={};eJ=f("aNJCr").getBundleURL("EVgbq")+f("iE7OH").resolve("2344Y");var eV={};eV=f("aNJCr").getBundleURL("EVgbq")+f("iE7OH").resolve("53vZ8");var eG={};eG=f("aNJCr").getBundleURL("EVgbq")+f("iE7OH").resolve("3muyk");let eW=new eM,eK=eq.create('<div class="js-modal"></div>',{onShow:()=>{document.addEventListener("keydown",eQ),document.body.style.overflow="hidden"},onClose:()=>{document.removeEventListener("keydown",eQ),document.body.style.overflow="visible"}});async function eY(t){e0=await eW.fetchDetailsByBookId(t);let{book_image:e,title:r,author:n,description:o,buy_links:i}=e0;eK.show();let s=document.querySelector(".js-modal");s.innerHTML=`<div class="modal container">
  ...
  `;let l=document.querySelector(".modal-close-btn");l.addEventListener("click",eX);let u=document.querySelector(".js-add-list-btn");if(u.addEventListener("click",e1),!ez.user.isAuth){u.textContent="PLEASE SIGN IN TO CONTINUE",u.disabled=!0;return}eZ.find(e=>e._id===t)?u.textContent="REMOVE FROM THE SHOPPING LIST":u.textContent="ADD TO SHOPING LIST"}function eX(t){eK.close()}function eQ(t){"Escape"===t.code&&eK.close()}// ================ Local Storage
let eZ=[],e0={};function e1(t){var e;let r=t.target.dataset.id,n=document.querySelector(".text-info");eZ.find(t=>t._id===r)?(eZ=eZ.filter(t=>t._id!==r),t.target.textContent="ADD TO SHOPING LIST",n.classList.add("is-hidden")):(eZ.push(e0),t.target.textContent="REMOVE FROM THE SHOPPING LIST",n.classList.remove("is-hidden")),e=eZ,(0,ez.user).writeBooksToDB(ez.user.userID,JSON.stringify(e))}(0,ez.user).readUserData(ez.user.userID).then(t=>{t&&t.books&&(eZ=JSON.parse(t.books))});var e2=f("6JpON");let e6=document.querySelector(".js-cards"),e5=new eM;async function e8(){/*@__PURE__*/a(e2).Loading.standard();let t=await e5.fetchTopBooks(),e=t.map(t=>`<div>
      ...
      </div>`;let o=document.querySelectorAll(".js-card-click");o.forEach(t=>{t.addEventListener("click",t=>{eY(t.currentTarget.dataset.id)})})}catch(t){/*@__PURE__*/a(e2).Notify.failure(t.message)}/*@__PURE__*/a(e2).Loading.remove()}function e3(t,e){return`<div class='one-book-container col-${e} js-card-click' data-id="${t._id}">
       <div class="wrap">
      ...
      </div>`}e8();var e2=f("6JpON");document.querySelector(".js-cards");let e7=document.querySelector(".categoryes");(async function(){try{let t=new eM,e=await t.fetchCategoryList(),r=e.map(t=>`<li class="categorie-item"><button data-list_name="${t.list_name}" class="categorie-btn">${t.list_name}</button>
      </li>`).join("");if(e7.innerHTML=`<ul class="categorie-list list"><li class="categorie-item"><button class="categorie-btn active">All categories</button></li>${r}</ul>`,0===e.length)throw Error("No categories found");let n=document.querySelectorAll(".categorie-btn");n.forEach(t=>{t.addEventListener("click",e=>{document.querySelector(".categorie-btn.active").classList.remove("active"),e4(t.textContent),t.classList.add("active")})})}catch(t){(0,e2.Notify).failure(t.message)}})(),f("d6S5l"),f("23Ajj"),f("7hKzD"),f("yTOug"),f("d0uJe"),f("7ADRq");let e9=document.querySelectorAll(".js-index_menu");e9.forEach(t=>t.classList.add("active"))}();//# sourceMappingURL=index.6205f8d5.js.map

//# sourceMappingURL=index.6205f8d5.js.map
